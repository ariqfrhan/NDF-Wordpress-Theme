...
<body>
    <header>
        <nav id="bar">
            ...
            <ul id="menu-home">
                <li id="menu-title">
                    <p id="text-menu-title" onclick="location.href = '#'">Home</p>
                </li>
                <li id="menu-title">
                    <div id="menu-drop">
    ...
    <section>
        <div id="banner">
            <div id="bg"></div>
            <img id="banner-photo"
                src="https://res.cloudinary.com/dndidjvfj/images/v1665509209/WhatsApp-Image-2022-04-05-at-16.09.15/WhatsApp-Image-2022-04-05-at-16.09.15.jpeg?_i=AA"
                alt="">
            <img id="border-bg"
                src="https://res.cloudinary.com/dndidjvfj/images/v1665509090/shape-cover-homepage/shape-cover-homepage.png?_i=AA"
                alt="border">
            <div id="title-banner">
        ...
        <div id="content">
            <div id="identitas">
                <div id="box-logo">
                    <div id="logo-border">
                        <img id="logo-ndf"
                            src="https://res.cloudinary.com/dndidjvfj/images/v1665509331/cropped-Logo-NDF-White-4/cropped-Logo-NDF-White-4.jpg?_i=AA"
                            alt="logo-ndf">
                    </div>
                </div>
                <div id="description">
                    <p>
                        Nol Derajat Film adalah Unit Kegiatan Mahasiswa Universitas Brawijaya Malang yang bergerak pada
                        bidang sinematografi. Nol Derajat Film merupakan wadah untuk bersama-sama berproses dan berkarya
                        dalam berbagai aspek perfilman.<br><br>
                        Didirikan Pada Tanggal 19 September 2011 Oleh Beberapa Mahasiswa Yang Memiliki Minat Yang Sama
                        Pada Film, Kini Nol Derajat Film Terus Berkembang Dan Bergerak Menghasilkan Berbagai Karya.
                    </p>
                </div>
            </div>
            <div id="vmp">
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div id="visi">
                                <img id="letter"
                                    src="https://res.cloudinary.com/dndidjvfj/images/v1665509144/visi/visi.png?_i=AA"
                                    alt="letter">
                                <h3>Visi</h3>
                                <div id="content-vmp">
                                    <p>Menjadikan Nol Derajat Film sebagai ruang dimana setiap anggotanya dapat
                                        menuangkan kreativitas serta mengembangkan potensi minat dan bakat khususnya
                                        dalam bidang perfilman dengan lingkungan yang nyaman untuk setiap anggotanya.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div id="misi">
                                ...
                                <div id="content-vmp">
                                    <ol>
                                        <li>
                                            <p>Menciptakan program kerja yang unggul, inovatif, dan adaptif dengan
                                                melibatkan seluruh anggota Nol Derajat Film agar saling bersinergis.</p>
                                        </li>
                                        <li>
                                            <p>Mendorong setiap anggota Nol Derajat Film untuk dapat berekspresi dan
                                                berprestasi sesuai minat dan bakat sebagai upaya untuk meningkatkan
                                                kualitas sumber daya manusia khususnya dalam bidang perfilman.</p>
                                        </li>
                                        <li>
                                            <p>Menjalin relasi yang kuat baik internal maupun eksternal Nol Derajat Film
                                                guna menciptakan suasana kerja yang nyaman.</p>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item">
                            <div id="prestasi">
                                ...
                                <div id="content-vmp">
                                    <ol>
                                        <li>
                                            <p>HAKUNA MATATA - FINALIS<br>FESTIVAL DOKUMENTER BUDI LUHUR (2017)</p>
                                        </li>
                                        <li>
                                            <p>MANUSIA-MANUSIA BIASA DALAM KANDANG PENGUASA - OFFICIAL
                                                SELECTION<br>MALANG FILM FESTIVAL (2018)</p>
                                        </li>
                                        <li>
                                            <p>YTH. - JUARA 3<br>VITAL VOICES FESTIVAL, PERUM PRODUKSI FILM NEGARA
                                                (2020)</p>
                                        </li>
                                        <li>
                                            <p>YTH. - NOMINEE BEST SHORT MOVIE<br>COMMUNICATION SHORT FILM COMPETITION
                                                (2021)</p>
                                        </li>
                                        <li>
                                            <p>YTH., DELUSIVE, KAWAN ASTRAL - OFFICIAL SELECTION<br>CUT FILM FESTIVAL
                                                (2021)</p>
                                        </li>
                                        <li>
                                            <p>WRONG LITTLE STEPS - OFFICIAL SELECTION<br>9TH PSYCHOLOGY FILM FESTIVAL
                                                (2021)</p>
                                        </li>
                                    </ol>
                                </div>
                    ...
                    <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
                        <div
                            style="margin-top: 7.5em;height: 2em; width: 2em; border: 1px solid; border-radius: 100%; background-color: blueviolet; text-align: center; display: flex; justify-content: center; align-items: center;">
            ...
            <div id="berita">
                <div id="box-decor-news">
                    <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509171/megaphone/megaphone.png?_i=AA"
                        alt="megaphone" id="megaphone">
                </div>
                <div id="title-news">
                    <h3>Whats New ?</h3>
                </div>
                <ul>
                            ...
                            <li>
                                <div id="new">
                                    ...
                                    if (has_post_thumbnail()) {
                                        ...
                                        ?>
                                        <img src="http://nolderajatfilm.ub.ac.id/wp-content/themes/NolDerajat/images/plan.jpg"
                                            width="290" height="290" alt="berita">
                                    <?php } ?>
                    ...
                    <!-- <li>
                        <div id="new">
                            <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509015/logo/logo.png?_i=AA" width="290" height="290" alt="berita">
                ...
                <!-- <a href="https://jakartafilmweek.com/">
                    <img src="https://res.cloudinary.com/dndidjvfj/images/v1665547958/Web-Banner-Community-tanpa-kotak-04/Web-Banner-Community-tanpa-kotak-04.png?_i=AA" alt="JFW" style="margin-top: 25px;">
                </a> -->
            </div>
            <div id="film">
                <div id="trailer">
                    ...
                    for ($i = 0; $i < count($trailer); $i++) {
                        ...
                        <div id="trailer-<?php echo $i + 1 ?>">
                            <div id="trailer-movie">
                                <iframe src="<?php echo $trailer[$i]->link_trailer ?>" title="YouTube video player"
                                    frameborder="0"
                ...
                <div id="title-cinema">
                    <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509202/cinema/cinema.png?_i=AA"
                        alt="cinema" id="cinema">
                    <h1>Cinema</h1>
                </div>
                                    ...
                                    <div id="movie-right">
                                        <div id="title-movie">
                                            <div id="title-movie-content">
                                                <h3>
                                                    <?php echo $film[$i]->nama ?>
                                                </h3>
                                                <span>
                                                    <?php echo $film[$i]->tahun ?> &bull; dir.
                                                    <?php echo $film[$i]->director ?>
                                                </span>
                                            </div>
                                        </div>
                                        <div id="sinopsisbox">
                                            <h5>
                                                <?php echo $film[$i]->sinopsis ?>
                                            </h5>
                                            <div id="btn-watch-box">
                                                <button id="btn-watch" onclick="Trailer(<?php echo $i + 1 ?>)"><i
                                                        class="fa-solid fa-circle-play"></i>Watch Now</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="konten">
                <img id="mic"
                    src="https://res.cloudinary.com/dndidjvfj/images/v1665509154/table_microphone/table_microphone.png?_i=AA"
                    alt="mic">
                <div id="clip">
                    <div id="btnslideclip">
                    ...
                    <ul id="clipbox" class="click">
                        <li><img src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/WOTM-April_Prev.png"
                                alt="WOTM"></li>
                        <li><img src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/WUS-Mei_Prev.png"
                                alt="WUS"></li>
                        <li><img src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/MOTION-April_Prev.png"
                                alt="Motion"></li>
                        <li><img src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/Podcast-Mei_Prev.png"
                                alt="Podcast"></li>
                        <li><img src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/REVIEW-GGW_Prev.png"
                                alt="Review Film"></li>
                    </ul>
                </div>
                <ul id="kontenbox">
                    <li>
                        ...
                        <div id="konten-item">
                            <h2>WOTM</h2>
                            <h4>(Whats On This Month)</h4>
                        </div>
                        <div id="lanjut">
                            <button
                                onclick="window.open('https://www.instagram.com/p/Crk82EcSaD9/?igshid=MDI2Mzg4NTI', '_blank')">view
                                more</button>
                        </div>
                    </li>
                    <li>
                        ...
                        <div id="lanjut">
                            <button
                                onclick="window.open('https://www.instagram.com/reel/Cr-s24YA7il/?igshid=NTc4MTIwNjQ2YQ', '_blank')">view
                                more</button>
                        </div>
                    </li>
                    <li>
                        ...
                        <div id="lanjut">
                            <button
                                onclick="window.open('https://www.instagram.com/reel/CrdOm-KgTDM/?igshid=YmMyMTA2M2Y', '_blank')">view
                                more</button>
                        </div>
                    </li>
                    <li>
                        ...
                        <div id="lanjut">
                            <button
                                onclick="window.open('https://open.spotify.com/episode/1OgOuB9ZglqQWTdCvMcXWC?si=suFDAKujQ6aSFwzIEtxWHw', '_blank')">view
                                more</button>
                        </div>
                    </li>
                    <li>
                        ...
                        <div id="lanjut">
                            <button
                                onclick="window.open('https://www.instagram.com/p/CrqJNJIyFR7/?igshid=MDI2Mzg4NTI%3D', '_blank')">view
                                more</button>
                        </div>
                    </li>
                </ul>
        ...
        <div id="pengurus">
            <img id="rocket" src="https://res.cloudinary.com/dndidjvfj/images/v1665509164/Rocket/Rocket.png?_i=AA"
                alt="rocket" height="400px">
            ...
            <div id="bph">
                <div id="desc-bidang">
                    <ul>
                        <li>
                            <div class="desc-dec">
                                <h5>Pengurus Inti</h5>
                                <p>Bertanggung jawab dalam mengoordinasikan kegiatan dan pengembangan Nol Derajat Film
                                    dalam bentuk pelaksanaan program kerja bersama dengan seluruh jajaran pengurus.</p>
                            </div>
                        </li>
                        <li>
                            <div class="desc-dec">
                                <h5>Administration & Finance</h5>
                                <p>Berperan dalam mengurus segala sesuatu yang berkaitan dengan kesekretariatan
                                    (termasuk administratif) dan perbendaharaan.</p>
                            </div>
                        </li>
                        <li>
                            <div class="desc-dec">
                                <h5>Pengembangan Sumber Daya Internal</h5>
                                <p>Berperan dalam pengawasan dan pengembangan kerekatan hubungan internal Nol Derajat
                                    Film.</p>
                            </div>
                        </li>
                        <li>
                            <div class="desc-dec">
                                ...
                                <p>Berperan dalam pemeliharaan dan pengembangan minat dan bakat sumber daya manusia yang
                                    ada serta mengurus perekrutan anggota baru.</p>
                            </div>
                        </li>
                        <li>
                            <div class="desc-dec">
                                <h5>Distribusi Eksbihisi Apresiasi</h5>
                                <p>Merancang dan melaksanakan segala kegiatan yang berhubungan dengan distribusi,
                                    ekshibisi, dan apresiasi film-film hasil karya Nol Derajat Film.</p>
                            </div>
                        </li>
                        <li>
                            <div class="desc-dec">
                                <h5>Produksi</h5>
                                <p>Merancang dan melaksanakan segala kegiatan yang berkaitan dengan produksi film karya
                                    Nol Derajat Film.</p>
                            </div>
                        </li>
                        <li>
                            <div class="desc-dec">
                                ...
                                <p>Berperan sebagai media penghubung dan informasi antara pihak internal dan eksternal
                                    terkait apapun yang berhubungan dengan Nol Derajat Film dan edukasi sinematografi
                                    serta pengembangan website.</p>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="inti">
                        <li>
                            <div id="item-foto-bph">
                                <img class="img-bph"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/Inti.png" alt="Inti">
                                <div id="deskripsi-bid">
                                    <h5>Pengurus Inti</h5>
                                    <p>Bertanggung jawab dalam mengoordinasikan kegiatan dan pengembangan Nol Derajat
                                        Film dalam bentuk pelaksanaan program kerja bersama dengan seluruh jajaran
                                        pengurus.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive img-bph"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/AnF.png" alt="AnF">
                                <div id="deskripsi-bid">
                                    <h5>Administration & Finance</h5>
                                    <p>Anf merupakan biro yang keberadaanya didasari oleh beberapa kebutuhan internal
                                        NDF. Kebutuhan tersebut secara garis besar terbagi menjadi administrasi dan
                                        finansial.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive img-bph"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/PSDI.png" alt="PSDI">
                                <div id="deskripsi-bid">
                                    <h5>Pengembangan Sumber Daya Internal</h5>
                                    <p>Berperan dalam pengawasan dan pengembangan kerekatan hubungan internal Nol
                                        Derajat Film.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive img-bph"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/PSDM.png" alt="PSDM">
                                <div id="deskripsi-bid">
                                    <h5>Pengembangan Sumber Daya Mahasiswa</h5>
                                    <p>Berperan dalam pemeliharaan dan pengembangan minat dan bakat sumber daya manusia
                                        yang ada serta mengurus perekrutan anggota baru.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/DEA.png" alt="DEA">
                                <div id="deskripsi-bid">
                                    <h5>Distribusi Eksbihisi Apresiasi</h5>
                                    <p>Merancang dan melaksanakan segala kegiatan yang berhubungan dengan distribusi,
                                        ekshibisi, dan apresiasi film-film hasil karya Nol Derajat Film.</p>
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/Prroduksi.png"
                                    alt="Produksi">
                                <div id="deskripsi-bid">
                                    <h5>Produksi</h5>
                                    <p>Merancang dan melaksanakan segala kegiatan yang berkaitan dengan produksi film
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive"
                                    src="https://nolderajat.ub.ac.id/wp-content/uploads/2023/05/HUMI.png" alt="HUMI">
                                <div id="deskripsi-bid">
                                    <h5>Hubungan Masyarakat dan Informatika</h5>
                                    <p>Berperan sebagai media penghubung dan informasi antara pihak internal dan
                                        eksternal terkait apapun yang berhubungan dengan Nol Derajat Film dan edukasi
                                        sinematografi serta pengembangan website.</p>
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <div id="list-bidang">
                    <ul>
                        <li>
                            <h4 onclick="inti()">Inti</h4>
                        </li>
                        <li>
                            <h4 onclick="sekbend()">AnF</h4>
                        </li>
                        <li>
                            <h4 onclick="psdi()">PSDI</h4>
                        </li>
                        <li>
                            <h4 onclick="psdm()">PSDM</h4>
                        </li>
                        <li>
                            <h4 onclick="dea()">DEA</h4>
                        </li>
                        <li>
                            <h4 onclick="produksi()">Produksi</h4>
                        </li>
                        <li>
                            <h4 onclick="humi()">HUMI</h4>
                        </li>
        ...
        <div id="kontak">
            <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509191/gameboy/gameboy.png?_i=AA" alt="game"
                id="game" width="500px">
            ...
            <form action="" method="post">
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" placeholder="Nama" name="nama" <?php if (isset($_POST["nama"])) {
                        $nama = $_POST["nama"];
                        echo "value='$nama'";
                    } ?> required>
                ...
                <div class="form-floating">
                    <input type="email" class="form-control" id="floatingEmail" placeholder="Email" name="email" <?php if (isset($_POST["email"])) {
                        $email = $_POST["email"];
                        echo "value='$email'";
                    } ?> required>
                ...
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Leave a message here" id="floatingMessage"
                        style="height: 150px" name="message" <?php if (isset($_POST["message"])) {
                ...
                <span>
                    <?php if (isset($send)) {
                        if ($send == true)
                            echo "Success to submit form";
                        else
                            echo "Error when submit form";
                        unset($send);
                    } ?>
                </span>
    ...
    <footer>
        <div id="foot">
            <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509179/keyboard1/keyboard1.png?_i=AA"
                alt="keyboard" id="keyboard" height="300px" width="300px">
            <div id="lfoot">
                <div id="alamat">
                    <i onclick="window.open('https://goo.gl/maps/t8RLoH8HAQZnuGDQ6', '_blank')"
                ...
                <div id="cp">
                    <ul>
                        <li>
                            <i onclick="window.open('https://wa.me/6289666666629', '_blank')"
                                class="fa-brands fa-whatsapp"></i>
                            <p>+62 896-6666-6629 (Adel)</p>
                        </li><br>
                        <li>
                            <i onclick="window.open('https://wa.me/6281536921836', '_blank')"
                                class="fa-brands fa-whatsapp"></i>
                            <p>+62 815-3692-1836 (Putri)</p>
                        </li><br>
                        <li>
                            <i onclick="window.open('https://mail.google.com/mail/u/0/?fs=1&tf=cm&to=ukmnolderajatfilm@gmail.com', '_blank')"
                ...
                <div id="subscribe">
                    ...
                    <form id="form-subs" action="" method="post">
                        ...
                        <div id="centang">
                            ...
                            <p onclick="document.getElementById('check').checked = true">By submitting my personal
                                information, i understand and agree that Nol Derajat Film may collect, process, and
                                retain my data</p>
                        </div>
                    </form>
                    <?php
                    if (isset($_POST["submit"])) {
                        ...
                        if ($users)
                            echo "<p id='respon'>Email Already Noted!</p>";
                        else {
                            $sql = $wpdb->prepare('INSERT INTO subscribe_email (email) VALUES ("' . $_POST["email"] . '")');
                            $result = $wpdb->query($sql);
                            if ($result)
                                echo "<p id='respon'>Success submitted email..</p>";
                            else
                                echo "<p id='respon'>Something Wrong!! Try Again!</p>";
                        }
                    }
                    ?>
                </div>
                <div id="sosmed">
                    <ul>
                        ...
                        <li onclick="window.open('https://liff.line.me/1645278921-kWRPP32q?accountId=lnp4721a&openerPlatform=native&openerKey=home%3Arecommend', '_blank')"
                            id="line">
            ...
            <div id="rfoot">
                <div id="maps">
                    <div id="content-maps">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d987.862755273429!2d112.61604744658526!3d-7.952255508708844!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7882777ecb55eb%3A0xac4676caf0049153!2sRusunawa%20UB!5e0!3m2!1sid!2sid!4v1649001527739!5m2!1sid!2sid"
    ...
    <div id="ngalorngidul">
        ...
        <div id="blok-yt">
            <iframe src="https://www.youtube-nocookie.com/embed/Efns_qLZDTA?controls=0&autoplay=1"
    ...
    <script type="text/javascript"
        src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=true&amp;key=ABQIAAAAa24xicak8_ghHX58i7La7hRFh9iM79SNC94rOejOtdMRvQmJiBS6Uv5F_1BNSh9ZuSzFXyekHISgew">    </script>
