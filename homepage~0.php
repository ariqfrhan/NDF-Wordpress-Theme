...
<?php loading() ?>
	<header>
        <nav id="bar">
            <div onclick="location.href = ''" id="bar-logo">
                <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509229/logonol2/logonol2.png?_i=AA" alt="logo-nolder">
            ...
            <ul id="menu-home">
                ...
                <li id="menu-title">
                    ...
                    <ul id="profil-menu-3" class="profil-menu">
                        ...
                        <li onclick="location.href = 'http://nolderajatfilm.ub.ac.id/nolder-rent/'"><p id="submenu-title">Nolder Rent</p></li>                    
					</ul>
				</li>
    ...
    <section>
        <div id="banner">
            <div id="bg"></div>
            <img id="banner-photo" src="https://res.cloudinary.com/dndidjvfj/images/v1665509209/WhatsApp-Image-2022-04-05-at-16.09.15/WhatsApp-Image-2022-04-05-at-16.09.15.jpeg?_i=AA" alt="">
            <img id="border-bg" src="https://res.cloudinary.com/dndidjvfj/images/v1665509090/shape-cover-homepage/shape-cover-homepage.png?_i=AA" alt="border">
            <div id="title-banner">
        ...
        <div id="content">
            <div id="identitas">
                <div id="box-logo">
                    <div id="logo-border">
                        <img id="logo-ndf" src="https://res.cloudinary.com/dndidjvfj/images/v1665509331/cropped-Logo-NDF-White-4/cropped-Logo-NDF-White-4.jpg?_i=AA" alt="logo-ndf">
                    </div>
                </div>
                <div id="description">
                    <p>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div id="visi">
                                <img id="letter" src="https://res.cloudinary.com/dndidjvfj/images/v1665509144/visi/visi.png?_i=AA" alt="letter">
                                <h3>Visi</h3>
                                <div id="content-vmp">
            ...
            <div id="film">
                ...
                <div id="title-cinema">
                    <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509202/cinema/cinema.png?_i=AA" alt="cinema" id="cinema">
                    <h1>Cinema</h1>
                </div>
            ...
            <div id="konten">
                <img id="mic" src="https://res.cloudinary.com/dndidjvfj/images/v1665509154/table_microphone/table_microphone.png?_i=AA" alt="mic">
                <div id="clip">
                    <div id="btnslideclip">
                    ...
                    <ul id="clipbox" class="click">
                        <li><img src="https://res.cloudinary.com/dndidjvfj/images/v1665509048/Group-8/Group-8.png?_i=AA" alt="WOTW"></li>
                        <li><img src="https://res.cloudinary.com/dndidjvfj/images/v1665509043/Group-6/Group-6.png?_i=AA" alt="WUS"></li>
                        <li><img src="https://res.cloudinary.com/dndidjvfj/images/v1665509030/Group-10/Group-10.png?_i=AA" alt="Motion"></li>
                        <li><img src="https://res.cloudinary.com/dndidjvfj/images/v1665509021/Group-11/Group-11.png?_i=AA" alt="Podcast"></li>
                        <li><img src="https://res.cloudinary.com/dndidjvfj/images/v1665509036/Group-7/Group-7.png?_i=AA" alt="Review Film"></li>
                    </ul>
                </div>
                <ul id="kontenbox">
                    <li>
        ...
        <div id="pengurus">
            <img id="rocket" src="https://res.cloudinary.com/dndidjvfj/images/v1665509164/Rocket/Rocket.png?_i=AA" alt="rocket" height="400px">
                    ...
                    <ul class="inti">
                        <li>
                            <div id="item-foto-bph">
                                <img class="" src="https://res.cloudinary.com/dndidjvfj/images/v1665509125/KETUM-WA/KETUM-WA.png?_i=AA" alt="Inti">
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive" src="https://res.cloudinary.com/dndidjvfj/images/v1665509102/SEKBEND/SEKBEND.png?_i=AA" alt="SekBend">
                                <div id="deskripsi-bid">
                                    <h5>Sekretaris Bendahara</h5>
                                    <p>Berperan dalam mengurus segala sesuatu yang berkaitan dengan kesekretariatan (termasuk administratif) dan perbendaharaan.</p>
                                </div>
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive" src="https://res.cloudinary.com/dndidjvfj/images/v1665509113/PSDI/PSDI.png?_i=AA" alt="PSDI">
                                <div id="deskripsi-bid">
                                    <h5>Pengembangan Sumber Daya Internal</h5>
                                    <p>Berperan dalam pengawasan dan pengembangan kerekatan hubungan internal Nol Derajat Film.</p>
                                </div>
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive" src="https://res.cloudinary.com/dndidjvfj/images/v1665509108/PSDM/PSDM.png?_i=AA" alt="PSDM">
                                <div id="deskripsi-bid">
                                    <h5>Pengembangan Sumber Daya Mahasiswa</h5>
                                    <p>Berperan dalam pemeliharaan dan pengembangan minat dan bakat sumber daya manusia yang ada serta mengurus perekrutan anggota baru.</p>
                                </div>
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive" src="https://res.cloudinary.com/dndidjvfj/images/v1665509137/DEA/DEA.png?_i=AA" alt="DEA">
                                <div id="deskripsi-bid">
                                    <h5>Distribusi Eksbihisi Apresiasi</h5>
                                    <p>Merancang dan melaksanakan segala kegiatan yang berhubungan dengan distribusi, ekshibisi, dan apresiasi film-film hasil karya Nol Derajat Film.</p>
                                </div>
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive" src="https://res.cloudinary.com/dndidjvfj/images/v1665509120/PRODUKSI/PRODUKSI.png?_i=AA" alt="Produksi">
                                <div id="deskripsi-bid">
                                    <h5>Produksi</h5>
                                    <p>Merancang dan melaksanakan segala kegiatan yang berkaitan dengan produksi film karya Nol Derajat Film.</p>
                                </div>
                        ...
                        <li>
                            <div id="item-foto-bph">
                                <img class="inactive" src="https://res.cloudinary.com/dndidjvfj/images/v1665509130/HUMI/HUMI.png?_i=AA" alt="HUMI">
                                <div id="deskripsi-bid">
                                    <h5>Hubungan Masyarakat dan Informatika</h5>
                                <p>Berperan sebagai media penghubung dan informasi antara pihak internal dan eksternal terkait apapun yang berhubungan dengan Nol Derajat Film dan edukasi sinematografi serta pengembangan website.</p>
                                </div>
        ...
        <div id="kontak">
            <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509191/gameboy/gameboy.png?_i=AA" alt="game" id="game" width="500px">
    ...
    <footer>
        <div id="foot">
            <img src="https://res.cloudinary.com/dndidjvfj/images/v1665509179/keyboard1/keyboard1.png?_i=AA" alt="keyboard" id="keyboard" height="300px" width="300px">
            <div id="lfoot">
                <div id="alamat">
    ...
    <div id="ngalorngidul">
        ...
        <div id="blok-yt">
            <iframe src="https://www.youtube-nocookie.com/embed/cTijD2aCe-A?controls=0&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
